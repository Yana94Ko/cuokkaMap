...
//     } // markers state 일때
    ...
    //     //DB검색한 것이 있을때
    //     if (searchedPlaceInfoInNav.length > 0) {
    //         //searchedPlaceInfoInNav를 지우는 연산
    ...
    return <>
        ...
        <MapNavigationBar setSearchedPlaceInfoInNav={setSearchedPlaceInfoInNav} setConfirmCafeInfo={setConfirmCafeInfo} removeMarker={removeMarker}/>
