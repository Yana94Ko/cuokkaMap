...
public class UserServiceImpl implements UserService{
    ...
    @Override
    public String getLogin_idByUserNum(int user_num) {return dao.getLogin_idByUserNum(user_num);}

    @Override
    public int deleteUser(int user_num) {return dao.deleteUser(user_num);}
